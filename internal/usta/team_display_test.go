...
func TestDisplay(t *testing.T) {
	tests := map[string]struct {
		...
		"18+ mens singular (no s)": {
			name:        "2026 Men 18+ 6.5",
			gender:      GenderMens,
			level:       "6.5",
			daytime:     false,
			genderEmoji: "👬",
		},
		"18+ womens singular (no s)": {
			name:        "2026 Women 18+ 7.0",
			gender:      GenderWomens,
			level:       "7.0",
			daytime:     false,
			genderEmoji: "👭",
		},
		"18+ mens smart apostrophe": {
			name:        "2026 Men’s 18+ 6.5",
			gender:      GenderMens,
			level:       "6.5",
			daytime:     false,
			genderEmoji: "👬",
		},
		"18+ womens smart apostrophe": {
			name:        "2026 Women’s 18+ 7.0",
			gender:      GenderWomens,
			level:       "7.0",
			daytime:     false,
			genderEmoji: "👭",
		...
		"combo mens": {
			name:        "2026 Combo Mens League 6.5",
			gender:      GenderMens,
			level:       "6.5",
			daytime:     false,
			genderEmoji: "👬",
		...
		"combo womens": {
			name:        "2026 Combo Womens League 5.5",
			gender:      GenderWomens,
			level:       "5.5",
			daytime:     false,
			genderEmoji: "👭",
		},
		"combo womens daytime": {
			name:        "2026 Combo Womens Daytime League 5.5 ",
			gender:      GenderWomens,
			level:       "5.5",
			daytime:     true,
			genderEmoji: "👭",
		},
		"combo mens with team number": {
			name:        "2026 Combo Mens League 7.5 1",
			gender:      GenderMens,
			level:       "7.5",
			daytime:     false,
			genderEmoji: "👬",
